...
# * completion
setopt LIST_TYPES # append trailing type identifiers when listing files
setopt COMPLETE_ALIASES # also complete switches for aliases
...
setopt MARK_DIRS # append trailing `/' when listing directories
